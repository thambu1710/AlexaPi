...
function install_os {
    apt-get update
    apt-get install curl git build-essential python3-dev python3-pip python3-setuptools swig libpulse-dev portaudio19-dev libportaudio2 vlc-bin sox libsox-fmt-mp3 -y
}
